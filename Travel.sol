...
contract Travel {
    uint256 _totalRoutes = 0;
    uint256 _totalTickets = 0;
    uint256 _totalSlots = 0;
    ...
    function updateRoute(
        ...
        for (uint256 slotId = 1; slotId <= _totalSlots; slotId++) {
    ...
    function deleteRoute(uint256 routeId) public {
        require(routeExists[routeId], "Route doesn't exist!");
    ...
    function getRoutes() public view returns (RouteStruct[] memory Routes) {
        uint256 totalRoutes;
        for (uint256 i = 1; i <= _totalRoutes; i++) {
    ...
    function deleteTimeSlot(uint256 routeId, uint256 slotId) public {
        require(
    ...
    function markTimeSlot(uint256 routeId, uint256 slotId) public {
        require(
            routeExists[routeId] && routeTimeSlot[slotId].routeId == routeId,
            "Route not found"
        );
